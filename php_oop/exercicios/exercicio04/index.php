...
<body>
    ...
    <ul>
        <?php foreach ($veiculos as $veiculo) :
            if ($veiculo->get_tipo() == 'automovel' and $veiculo->get_ano() <= 2015): ?>
    ...
    <ul>
        <?php foreach ($veiculos as $veiculo) :
            if ($veiculo->get_tipo() == 'aviao' and $veiculo->get_ano() <= 2015): ?>
                <li><?php $veiculo->apresentar(); ?></li>
        <?php endif;
        endforeach; ?>
    </ul>
    ...
    <ul>
        <?php foreach ($veiculos as $veiculo) :
            if ($veiculo->get_tipo() == 'barco' and $veiculo->get_ano() <= 2015): ?>
                <li><?php $veiculo->apresentar(); ?></li>
        <?php endif;
        endforeach; ?>
    </ul>
