...
<div class="card">
    ...
    <div class="card-body">
        <form action="?page=salvar-venda" method="POST">
            ...
            <input type="hidden" name="id" value="<?php echo $row->idvenda; ?>">
            <div class="mb-3">
                <label for="data_venda">Data da Venda:</label>
                <input type="date" class="form-control" name="data_venda" value="<?php echo $row->data_venda; ?>" required>
            </div>
            <div class="mb-3">
                <label for="valor_venda">Valor da Venda:</label>
                <input type="number" step="0.01" class="form-control" name="valor_venda" value="<?php echo $row->valor_venda; ?>" required>
            </div>
            <div class="mb-3">
                ...
                <select class="form-control" name="cliente_id" required>
                    ...
                    <?php while ($cliente = $res_clientes->fetch_object()): ?>
                        <option value="<?php echo $cliente->idcliente; ?>" <?php echo ($cliente->idcliente == $row->cliente_idcliente) ? 'selected' : ''; ?>>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="funcionario_id" required>
                    ...
                    <?php while ($funcionario = $res_funcionarios->fetch_object()): ?>
                        <option value="<?php echo $funcionario->idfuncionario; ?>" <?php echo ($funcionario->idfuncionario == $row->funcionario_idfuncionario) ? 'selected' : ''; ?>>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="modelo_id" required>
                    ...
                    <?php while ($modelo = $res_modelos->fetch_object()): ?>
                        <option value="<?php echo $modelo->idmodelo; ?>" <?php echo ($modelo->idmodelo == $row->modelo_idmodelo) ? 'selected' : ''; ?>>
