...
e separar em arrays os dados do ficheiro com a seguinte orientação:
...
- Valores alfanuméricos que contém a palavra 'TESTE' em qualquer posição, devem ir para o array $textos_teste;