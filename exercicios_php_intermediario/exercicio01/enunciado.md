## ENUNCIADO
No ficheiro index.php crie um formulário HTML com dois imputs.
O objetivo é escrever o código no ficheiro tratamento.php para alcançar o seguinte resultado:
...
a multiplicação do primeiro pelo segundo e dar o exercício como concluído.